...
import com.hotelbooking.projects.HotelHub.repository.HotelMinPriceRepository;
...
public class PricingUpdateService {
   ...
   // @Scheduled(cron = "*/5 * * * * *")//run after every 5 seconds
    @Scheduled(cron = "0 0 * * * *")//it will run every hour
